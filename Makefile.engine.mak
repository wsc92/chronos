...
ifeq ($(DO_VERSION),yes)
	ifeq ($(BUILD_PLATFORM),windows)
		CVERSION := $(shell $(DIR)\$(BUILD_DIR)\versiongen.exe $(VER_MAJOR) $(VER_MINOR))
		VERFILE := $(ASSEMBLY)\src\version.h
	else
		CVERSION := $(shell $(BUILD_DIR)/versiongen $(VER_MAJOR) $(VER_MINOR))
		VERFILE := $(ASSEMBLY)/src/version.h
	endif
...
# Write out the version file.
	@echo $(VER_COMMENT)\n > $(VERFILE)
	@echo #define CVERSION "$(CVERSION)" >> $(VERFILE)
else
	@rm -rf $(VERFILE)
# Write out the version file.
	@echo $(VER_COMMENT)\n > $(VERFILE)
