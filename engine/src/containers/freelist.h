/**
 * @file freelist.h
 * @William Craig github.com/wsc92
 ...
 */
CAPI void freelist_create(u64 total_size, u64* memory_requirement, void* memory, freelist* out_list);
 ...
 */
CAPI void freelist_destroy(freelist* list);
 ...
 */
CAPI b8 freelist_allocate_block(freelist* list, u64 size, u64* out_offset);
 ...
 */
CAPI b8 freelist_free_block(freelist* list, u64 size, u64 offset);
 ...
 */
CAPI b8 freelist_resize(freelist* list, u64* memory_requirement, void* new_memory, u64 new_size, void** out_old_memory);
 ...
 */
CAPI void freelist_clear(freelist* list);
 ...
 */
CAPI u64 freelist_free_space(freelist* list);
