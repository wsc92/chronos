 ...
 * @returns If successful, a pointer to a block of allocated memory; otherwise 0.
 */
CAPI void* callocate_aligned(u64 size, u16 alignment, memory_tag tag);
 ...
 * @param tag Indicates the use of the allocated block.
 */
CAPI void callocate_report(u64 size, memory_tag tag);
 ...
 * @param tag The tag indicating the block's use.
 */
CAPI void cfree_aligned(void* block, u64 size, u16 alignment, memory_tag tag);
 ...
 * @param tag The tag indicating the block's use.
 */
CAPI void cfree_report(u64 size, memory_tag tag);
 ...
 */
CAPI b8 cmemory_get_size_alignment(void* block, u64* out_size, u16* out_alignment);
...
/**
 * @brief Obtains the number of times callocate was called since the memory system was initialized.
