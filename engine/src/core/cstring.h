 ...
 */
CAPI i32 string_index_of(char* str, char c);
 ...
 */
CAPI b8 string_to_vec4(char* str, vec4* out_vector);
 ...
 * @return True if parsed successfully; otherwise false.
 */
CAPI b8 string_to_vec3(char* str, vec3* out_vector);
 ...
 * @return True if parsed successfully; otherwise false.
 */
CAPI b8 string_to_vec2(char* str, vec2* out_vector);
 ...
 * @return True if parsed successfully; otherwise false.
 */
CAPI b8 string_to_f32(char* str, f32* f);
 ...
 * @return True if parsed successfully; otherwise false.
 */
CAPI b8 string_to_f64(char* str, f64* f);
 ...
 * @return True if parsed successfully; otherwise false.
 */
CAPI b8 string_to_i8(char* str, i8* i);
 ...
 * @return True if parsed successfully; otherwise false.
 */
CAPI b8 string_to_i16(char* str, i16* i);
 ...
 * @return True if parsed successfully; otherwise false.
 */
CAPI b8 string_to_i32(char* str, i32* i);
 ...
 * @return True if parsed successfully; otherwise false.
 */
CAPI b8 string_to_i64(char* str, i64* i);
 ...
 * @return True if parsed successfully; otherwise false.
 */
CAPI b8 string_to_u8(char* str, u8* u);
 ...
 * @return True if parsed successfully; otherwise false.
 */
CAPI b8 string_to_u16(char* str, u16* u);
 ...
 * @return True if parsed successfully; otherwise false.
 */
CAPI b8 string_to_u32(char* str, u32* u);
 ...
 * @return True if parsed successfully; otherwise false.
 */
CAPI b8 string_to_u64(char* str, u64* u);
 ...
 * @return True if parsed successfully; otherwise false.
 */
CAPI b8 string_to_bool(char* str, b8* b);
