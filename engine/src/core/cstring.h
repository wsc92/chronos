 ...
 */
CAPI u32 string_utf8_length(const char* str);
 ...
 */
CAPI b8 bytes_to_codepoint(const char* bytes, u32 offset, i32* out_codepoint, u8* out_advance);
 ...
 */
CAPI void string_free(char* str);
 ...
 */
CAPI b8 strings_nequal(const char* str0, const char* str1, u64 length);
 ...
 * @return True if the same, otherwise false.
 */
CAPI b8 strings_nequali(const char* str0, const char* str1, u64 length);
 ...
 * @returns A pointer to the destination string.
 */
CAPI char* string_ncopy(char* dest, const char* source, i64 length);
 ...
 */
CAPI char* string_trim(char* str);
 ...
 * @param str The string to be trimmed.
 */
CAPI void string_mid(char* dest, const char* source, i32 start, i32 length);
 ...
 */
CAPI i32 string_index_of(const char* str, char c);
 ...
 */
CAPI b8 string_to_vec4(const char* str, vec4* out_vector);
 ...
 * @return True if parsed successfully; otherwise false.
 */
CAPI b8 string_to_vec3(const char* str, vec3* out_vector);
 ...
 * @return True if parsed successfully; otherwise false.
 */
CAPI b8 string_to_vec2(const char* str, vec2* out_vector);
 ...
 * @return True if parsed successfully; otherwise false.
 */
CAPI b8 string_to_f32(const char* str, f32* f);
 ...
 * @return True if parsed successfully; otherwise false.
 */
CAPI b8 string_to_f64(const char* str, f64* f);
 ...
 * @return True if parsed successfully; otherwise false.
 */
CAPI b8 string_to_i8(const char* str, i8* i);
 ...
 * @return True if parsed successfully; otherwise false.
 */
CAPI b8 string_to_i16(const char* str, i16* i);
 ...
 * @return True if parsed successfully; otherwise false.
 */
CAPI b8 string_to_i32(const char* str, i32* i);
 ...
 * @return True if parsed successfully; otherwise false.
 */
CAPI b8 string_to_i64(const char* str, i64* i);
 ...
 * @return True if parsed successfully; otherwise false.
 */
CAPI b8 string_to_u8(const char* str, u8* u);
 ...
 * @return True if parsed successfully; otherwise false.
 */
CAPI b8 string_to_u16(const char* str, u16* u);
 ...
 * @return True if parsed successfully; otherwise false.
 */
CAPI b8 string_to_u32(const char* str, u32* u);
 ...
 * @return True if parsed successfully; otherwise false.
 */
CAPI b8 string_to_u64(const char* str, u64* u);
 ...
 * @return True if parsed successfully; otherwise false.
 */
CAPI b8 string_to_bool(const char* str, b8* b);
 ...
 */
CAPI u32 string_split(const char* str, char delimiter, char*** str_darray, b8 trim_entries, b8 include_empty);
 ...
 */
CAPI void string_cleanup_split_array(char** str_darray);
 ...
 */
CAPI void string_append_string(char* dest, const char* source, const char* append);
 ...
 */
CAPI void string_append_int(char* dest, const char* source, i64 i);
 ...
 */
CAPI void string_append_float(char* dest, const char* source, f32 f);
 ...
 */
CAPI void string_append_bool(char* dest, const char* source, b8 b);
 ...
 */
CAPI void string_append_char(char* dest, const char* source, char c);
 ...
 */
CAPI void string_directory_from_path(char* dest, const char* path);
 ...
 * @param path The full path to extract from.
 */
CAPI void string_filename_from_path(char* dest, const char* path);
 ...
 * @param path The full path to extract from.
 */
CAPI void string_filename_no_extension_from_path(char* dest, const char* path);
...
CAPI void cstring_create(cstring* out_string);
CAPI void cstring_from_cstring(const char* source, cstring* out_string);
CAPI void cstring_destroy(cstring* string);

CAPI u32 cstring_length(const cstring* string);
CAPI u32 cstring_utf8_length(const cstring* string);

CAPI void cstring_append_str(cstring* string, const char* s);
CAPI void cstring_append_cstring(cstring* string, const cstring* other);
