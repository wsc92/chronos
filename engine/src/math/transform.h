 ...
 * by default.
 */
CAPI transform transform_create();
 ...
 */
CAPI transform transform_from_position(vec3 position);
 ...
 * @return A new transform.
 */
CAPI transform transform_from_rotation(quat rotation);
 ...
 * @return A new transform.
 */
CAPI transform transform_from_position_rotation(vec3 position, quat rotation);
 ...
 * @return A new transform.
 */
CAPI transform transform_from_position_rotation_scale(vec3 position, quat rotation, vec3 scale);
 ...
 */
CAPI transform* transform_get_parent(transform* t);
 ...
 */
CAPI void transform_set_parent(transform* t, transform* parent);
 ...
 */
CAPI vec3 transform_get_position(const transform* t);
 ...
 */
CAPI void transform_set_position(transform* t, vec3 position);
 ...
 */
CAPI void transform_translate(transform* t, vec3 translation);
 ...
 */
CAPI quat transform_get_rotation(const transform* t);
 ...
 */
CAPI void transform_set_rotation(transform* t, quat rotation);
 ...
 */
CAPI void transform_rotate(transform* t, quat rotation);
 ...
 */
CAPI vec3 transform_get_scale(const transform* t);
 ...
 */
CAPI void transform_set_scale(transform* t, vec3 scale);
 ...
 */
CAPI void transform_scale(transform* t, vec3 scale);
 ...
 * @param rotation The rotation to be set.
 */
CAPI void transform_set_position_rotation(transform* t, vec3 position, quat rotation);
 ...
 * @param scale The scale to be set.
 */
CAPI void transform_set_position_rotation_scale(transform* t, vec3 position, quat rotation, vec3 scale);
 ...
 * @return CAPI
 */
CAPI void transform_translate_rotate(transform* t, vec3 translation, quat rotation);
 ...
 */
CAPI mat4 transform_get_local(transform* t);
 ...
 */
CAPI mat4 transform_get_world(transform* t);
