 ...
 * @return KAPI 
 */
CAPI b8 filesystem_size(file_handle* handle, u64* out_size);
...
*/
CAPI b8 filesystem_read_line(file_handle* handle, u64 max_length, char** line_buf, u64* out_line_length);
 ...
 * @returns True if successful; otherwise false.
 */
CAPI b8 filesystem_read_all_text(file_handle* handle, char* out_text, u64* out_bytes_read);
