...
b8 renderer_system_initialize(u64* memory_requirement, void* state, const char* application_name) {
    *memory_requirement = sizeof(renderer_system_state);
    ...
    state_ptr->skybox_renderpass->targets = callocate(sizeof(render_target) * state_ptr->window_render_target_count, MEMORY_TAG_ARRAY);
    ...
    state_ptr->world_renderpass->targets = callocate(sizeof(render_target) * state_ptr->window_render_target_count, MEMORY_TAG_ARRAY);
    ...
    state_ptr->ui_renderpass->targets = callocate(sizeof(render_target) * state_ptr->window_render_target_count, MEMORY_TAG_ARRAY);
