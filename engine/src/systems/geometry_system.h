 ...
 */
CAPI geometry* geometry_system_acquire_by_id(u32 id);
 ...
 * @return A pointer to the acquired geometry or nullptr if failed. 
 */
CAPI geometry* geometry_system_acquire_from_config(geometry_config config, b8 auto_release);
 ...
 */
CAPI void geometry_system_config_dispose(geometry_config* config);
 ...
 */
CAPI void geometry_system_release(geometry* geometry);
 ...
 */
CAPI geometry* geometry_system_get_default();
 ...
 * @return A pointer to the default geometry. 
 */
CAPI geometry* geometry_system_get_default_2d();
 ...
 */
CAPI geometry_config geometry_system_generate_plane_config(f32 width, f32 height, u32 x_segment_count, u32 y_segment_count, f32 tile_x, f32 tile_y, const char* name, const char* material_name);
 ...
 */
CAPI geometry_config geometry_system_generate_cube_config(f32 width, f32 height, f32 depth, f32 tile_x, f32 tile_y, const char* name, const char* material_name);
