 ...
 * @return True on success; otherwise false.
 */
CAPI b8 render_view_system_create(const render_view_config* config);
 ...
 */
CAPI void render_view_system_on_window_resize(u32 width, u32 height);
 ...
 */
CAPI render_view* render_view_system_get(const char* name);
 ...
 * @return True on success; otherwise false.
 */
CAPI b8 render_view_system_build_packet(const render_view* view, struct linear_allocator* frame_allocator, void* data, struct render_view_packet* out_packet);
 ...
 * @return True on success; otherwise false.
 */
CAPI b8 render_view_system_on_render(const render_view* view, const render_view_packet* packet, u64 frame_number, u64 render_target_index);

CAPI void render_view_system_regenerate_render_targets(render_view* view);
