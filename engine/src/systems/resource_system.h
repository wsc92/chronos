...
CAPI b8 resource_system_load(const char* name, resource_type type, resource* out_resource);
CAPI b8 resource_system_load_custom(const char* name, const char* custom_type, resource* out_resource);
