 ...
 * @return True on success; otherwise false.
 */
CAPI b8 resource_system_register_loader(resource_loader loader);
 ...
 * @return True on success; otherwise false.
 */
CAPI b8 resource_system_load(const char* name, resource_type type, void* params, resource* out_resource);
 ...
 * @return True on success; otherwise false.
 */
CAPI b8 resource_system_load_custom(const char* name, const char* custom_type, void* params, resource* out_resource);
 ...
 */
CAPI void resource_system_unload(resource* resource);

/** @brief Returns the base path of the resource system. */
CAPI const char* resource_system_base_path();
