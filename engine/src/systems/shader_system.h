 ...
 */
CAPI b8 shader_system_create(renderpass* pass, const shader_config* config);
 ...
 */
CAPI u32 shader_system_get_id(const char* shader_name);
 ...
 */
CAPI shader* shader_system_get_by_id(u32 shader_id);
 ...
 * @return A pointer to a shader, if found; otherwise 0.
 */
CAPI shader* shader_system_get(const char* shader_name);
 ...
 * @return True on success; otherwise false.
 */
CAPI b8 shader_system_use(const char* shader_name);
 ...
 * @return True on success; otherwise false.
 */
CAPI b8 shader_system_use_by_id(u32 shader_id);
 ...
 */
CAPI u16 shader_system_uniform_index(shader* s, const char* uniform_name);
 ...
 * @return True on success; otherwise false.
 */
CAPI b8 shader_system_uniform_set(const char* uniform_name, const void* value);
 ...
 * @return True on success; otherwise false.
 */
CAPI b8 shader_system_sampler_set(const char* sampler_name, const texture* t);
 ...
 * @return True on success; otherwise false.
 */
CAPI b8 shader_system_uniform_set_by_index(u16 index, const void* value);
 ...
 * @return True on success; otherwise false.
 */
CAPI b8 shader_system_sampler_set_by_index(u16 index, const struct texture* t);
 ...
 * @return True on success; otherwise false.
 */
CAPI b8 shader_system_apply_global();
 ...
 * @return True on success; otherwise false.
 */
CAPI b8 shader_system_apply_instance(b8 needs_update);
 ...
 * @return True on success; otherwise false. 
 */
CAPI b8 shader_system_bind_instance(u32 instance_id);
